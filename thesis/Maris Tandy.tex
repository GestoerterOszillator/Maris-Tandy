...
\begin{align}
	\psi' = U\psi, \quad A'_\mu = U A_\mu A^\dagger - \frac{\ii}{g}U\partial_\mu U^\dagger, \quad F_{\mu\nu}' = U F_{\mu\nu} U^\dagger
\end{align}
...
\begin{align}
	\langle f(\phi)\rangle_J \equiv Z[J]^{-1} \frac{\delta S}{\delta \phi}\left[\frac{\delta}{\delta J(x)}\right]Z[J] = J(x)
\end{align}

\begin{align}
	\frac{\delta\Gamma}{\delta\tilde\phi(x)}\left[\tilde\phi(x) + \int_y \frac{\delta^2 \Gamma}{\delta\tilde\phi(x)\delta\tilde\phi(y)}\frac{\delta}{\delta\tilde\phi(y)}\right]
\end{align}
...
\begin{align}
	S(p^2, \mu^2)^{-1} &= Z_2(\ii \p + Z_m m) \\
	&+ Z_g^2 g^2 \int\limits_k^\Lambda Z_3 D^{ab}_{\mu\nu}(p-k, \mu^2)\left( \frac{\lambda^a}{2}\g_\mu \right)Z_2 S(k^2, \mu^2) \left( Z_{1F}^{-1} \Gamma^b_\nu(k, p, \mu^2) \right)
\end{align}
...
\begin{align}
	S(p^2, \mu^2)^{-1} &= Z_2(\ii \p + Z_m m)^{-1} \\ % todo
	&+ \frac{Z_2}{\tilde Z_3} g^2 \int\limits_k^\Lambda Z_3 D^{ab}_{\mu\nu}(p-k, \mu^2)\left( \frac{\lambda^a}{2}\g_\mu \right) S(k^2, \mu^2) \left( \Gamma^b_\nu(k, p, \mu^2) \right)
\end{align}
...
\begin{align}
	\frac{1}{Z_2 \tilde Z_3} g^2 D^{ab}_{\mu\nu}(p-k) \Gamma_\nu^b(k,p) \rightarrow \mathcal G\left((p-k)^2\right)\, \frac{t_{\mu\nu}(p-k)}{(p-k)^2}\frac{\lambda^a}{2}\g_\nu
\end{align}
