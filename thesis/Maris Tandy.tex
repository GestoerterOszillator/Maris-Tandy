...
\begin{align}
	Z[J] = e^{-W[J]} = e^{(\Gamma[\tilde\phi] - \int_x \tilde\phi J(x))}, \quad \Gamma[\tilde\phi] = W[J] - \tilde\phi J
\end{align}
...
\begin{align}
	...
	&+ Z_g^2 g^2 \int \dbar^4 q \; Z_3 D_{ab}^{\mu\nu}(p-q, \mu^2)\left( \frac{\lambda^a}{2}\g_\mu \right)Z_2 S(q^2, \mu^2) \left( Z_{1F}^{-1} \Gamma^b_\nu(p, q, \mu^2) \right)
\end{align}
...
\begin{align}
	Z_2\left(Z_g^2 Z_3 Z_2 \frac{\tilde Z_3}{Z_2}\right) = \frac{Z_2}{\tilde Z_3} \cdot \left[Z_g^2 \tilde Z_3^2 Z_3\right] = \frac{Z_2}{\tilde Z_3} = Z_{1F}
\end{align}

\begin{align}
	S^{-1}(p^2, \mu^2) &= Z_2(\ii \p + Z_m m)^{-1} \\ % todo
	&+ \frac{Z_2}{\tilde Z_3} g^2 \int \dbar^4 q \; Z_3 D_{ab}^{\mu\nu}(p-q, \mu^2)\left( \frac{\lambda^a}{2}\g_\mu \right) S(q^2, \mu^2) \left( \Gamma^b_\nu(p, q, \mu^2) \right)
\end{align}
...
\begin{align}
	\frac{1}{Z_2 \tilde Z_3} g^2 D_{ab}^{\mu\nu}(p-q) \Gamma_\nu^b(p,q) \rightarrow \mathcal G\left((p-q)^2\right)\, \frac{t^{\mu\nu}(p-q)}{(p-q)^2}\frac{\lambda^a}{2}\g_\nu
\end{align}
$t^{\mu\nu}(p) = \delta^{\mu\nu} + \frac{p^\mu p^\nu}{p^2}$
\begin{align}
