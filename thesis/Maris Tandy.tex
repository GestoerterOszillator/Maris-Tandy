...
\begin{align}
	\Gamma_{PS} (p,P) = \g^5 \left( E(p,P) - \ii \slashed P \, F(p,P) - \ii (p\cdot P) \,\p\; G(p,P) + \left[\p, \slashed P\right]_- H(p,P)  \right)
\end{align}
...
\begin{align}
	...
	=
	\begin{pmatrix}
		\kappa_{EE}(p,q) & \kappa_{EF}(p,q) & \kappa_{EG}(p,q) & \kappa_{EH}(p,q) \\
		\kappa_{FE}(p,q) & \kappa_{FF}(p,q) & \kappa_{FG}(p,q) & \kappa_{FH}(p,q) \\
		\kappa_{GE}(p,q) & \kappa_{GF}(p,q) & \kappa_{GG}(p,q) & \kappa_{GH}(p,q) \\
		\kappa_{HE}(p,q) & \kappa_{HF}(p,q) & \kappa_{HG}(p,q) & \kappa_{HH}(p,q)
	\end{pmatrix}
	\begin{pmatrix}
		E(q) \\
		F(q) \\
...
\begin{align}
	\Gamma(p,P) = -C_f Z_2^2 4\pi \int \dbar^4 q \g^\mu S(q_+) \Gamma(q,P) S(q_-) \g^\nu T_{\mu\nu}(k) \frac{\alpha(k^2)}{k^2}
\end{align}
...
\begin{align}
	p_E &= \frac{1}{4} \g^5 \\
	p_F &= \frac{\ii}{4\left((p\cdot P)^2 - p^2 P^2\right)} \g^5 \left( p^2 \slashed P - (p\cdot P) \p \right) \\
	p_G &= \frac{\ii}{4\left((p\cdot P)^2 - p^2 P^2\right)} \g^5 \left( \frac{P^2}{p\cdot P} \p - \slashed P\right) \\
	p_H &= \frac{1}{16\left((p\cdot P)^2 - p^2 P^2\right)} \g^5 \left[ \p, \slashed P \right]_-
\end{align}
